...
{
	static UClass* LevelSequenceClass = AkUEFindObject(TEXT("/Script/LevelSequence.LevelSequence"), true);
...
#else
			AssetPickerConfig.Filter.ClassNames.Add(ClassToFilter->GetFName());
#endif
		}
	}
