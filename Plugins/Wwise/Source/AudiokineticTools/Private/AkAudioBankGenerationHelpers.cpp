...
namespace AkAudioBankGenerationHelper
{
	...
	void DoClearSoundData(AkSoundDataClearFlags ClearFlags)
	{
		...
		if ((ClearFlags & AkSoundDataClearFlags::AssetData) == AkSoundDataClearFlags::AssetData)
		{
			...
			AkUEGetAssetsByClass(UAkAudioType::StaticClass(), allAudioTypeAssets, true);
			...
			AkUEGetAssetsByClass(UAkMediaAsset::StaticClass(), allMediaAssets, true);
			...
			AkUEGetAssetsByClass(UAkAssetPlatformData::StaticClass(), allPlatformData);
		...
		if ((ClearFlags & AkSoundDataClearFlags::OrphanMedia) == AkSoundDataClearFlags::OrphanMedia)
		{
			...
			TArray<FAssetData> allMediaAssets;
			AkUEGetAssetsByClass(UAkMediaAsset::StaticClass(), allMediaAssets);
			AkUEGetAssetsByClass(UAkLocalizedMediaAsset::StaticClass(), allMediaAssets);
		...
		if ((ClearFlags & AkSoundDataClearFlags::OrphanAssetData) == AkSoundDataClearFlags::OrphanAssetData)
		{
			...
			AkUEGetAssetsByClass(UAkAssetPlatformData::StaticClass(), AllAssetData);
