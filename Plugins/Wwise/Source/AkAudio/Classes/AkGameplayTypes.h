...
struct FAkExternalSourceInfo
{
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Audiokinetic|AkExternalSourceInfo")
	class UAkExternalMediaAsset* ExternalSourceAsset = nullptr;
...
struct AKAUDIO_API FAkSDKExternalSourceArray :  public TSharedFromThis<FAkSDKExternalSourceArray, ESPMode::ThreadSafe>
{
	...
	TArray<TWeakObjectPtr<UAkExternalMediaAsset>> MemoryLoadedMedia;
};

class UAkAudioEvent;
class AKAUDIO_API FWaitEndOfEventAsyncAction : public FWaitEndOfEventAction
{
public:
